...
module.exports.modelItemInSection = (name, id, data) => {
    ...
    if (!isDefined(name) && !isDefined(data))
        return '';


    return '<div class="models-item div-parent p-parent img-parent" id="div-vertical-item-model-' + id + '" onclick="modelItemVerticalBackgroundVisibility(this)">\n' +
