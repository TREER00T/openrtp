...
module.exports.detailItem = (route, description, id, isLastItem, detailsForParametersOrArgs) => {
    ...
    isDefined(route) ?
        ...
        isDefined(description) ?
            ...
            '        </div>' : '' +
            isLastItem ? '' : '<hr>\n' +
            isDefined(detailsForParametersOrArgs) ? detailsForParametersOrArgs : '' + '</div>\n';
}